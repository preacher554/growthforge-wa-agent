# WhatsApp Writing Engine

> Source: Runtime Architect v5 (adapted for GrowthForge master skill — tech-agnostic).

## Purpose

LLMs default to paragraph-structured, formal, and repetitive output. WhatsApp is a conversational medium. The mismatch is immediately visible to users and destroys the "this feels like a real person" quality.
...
GOOD (separate bubbles):
  ...
  [delay 1.8s]
  Bubble 2: "AI agent WhatsApp, integrasi CRM, sama dashboard performa tim"
  [delay 2.1s]
...
### Rule 7: WhatsApp-native formatting
