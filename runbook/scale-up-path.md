...
Do NOT scale infrastructure before Phase 0 and Phase 1 correctness work is complete: state machine, dedupe, handoff, fromMe classifier, and outbox pattern must be stable first.
