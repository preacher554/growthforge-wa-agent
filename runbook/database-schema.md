...
Use this as the reference schema for a WA Agent runtime. Every table that holds tenant data must include `tenant_id`. Apply RLS when any admin UI or multi-tenant API is added.
...
CREATE TABLE outbox_messages (
  ...
  conversation_id TEXT NOT NULL,
  content TEXT NOT NULL,
  content_hash TEXT NOT NULL,        -- for fromMe matching
