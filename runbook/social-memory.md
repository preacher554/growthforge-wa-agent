...
A WhatsApp AI that re-introduces the company on the third message feels broken. A WhatsApp AI that asks "Halo, ada yang bisa dibantu?" to someone it already greeted two hours ago feels like a machine with amnesia.
...
Stated intent: wants to automate WhatsApp for their end users
...
- [ ] Isolated per `(tenant_id, customer_jid)` — never global by phone
